...
{
    public static event Action<string> OnTeamSpawned;
    public static event Action<string> OnTeamDespawned;
    ...
    public override async void Spawned()
    {
        ...
        OnTeamSpawned?.Invoke(TeamId);
    }

    public override void Despawned(NetworkRunner runner, bool hasState)
    {
        if (ScoreManager.HasInstance)
            TeamSystem.Instance.RemoveTeam(this);

        OnTeamDespawned?.Invoke(TeamId);
    }

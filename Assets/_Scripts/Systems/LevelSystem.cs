...
namespace Systems
{
    public class LevelSystem : PersistentSingleton<LevelSystem>
    {
        ...
        private int ActiveSceneIndex => loadedScene?.buildIndex ?? 0;
        ...
        public class NetworkSceneManager : NetworkSceneManagerBase
        {
            protected override IEnumerator SwitchScene(SceneRef prevScene, SceneRef newScene, FinishedLoadingDelegate finished)
            {
                ...
                {
                    yield return SceneManager.UnloadSceneAsync(Instance.loadedScene.Value);
                }
                ...
                if (newScene >= 0)
                {
                    ...
                    sceneObjects = FindNetworkObjects(Instance.loadedScene.Value, disable: false);
                }
